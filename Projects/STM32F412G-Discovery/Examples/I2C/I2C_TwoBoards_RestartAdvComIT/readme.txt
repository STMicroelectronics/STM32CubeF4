...
2 STM32412G-DISCOVERY boards for exchanging some data
...
STM32412G-DISCOVERY boards LEDs can be used to monitor the transfer status :
...
STM32412G-DISCOVERY boards LEDs can be used to monitor the transfer status in both side:
Slave board side :
   - LED4 is turned ON when an Address match code event is acknowledge.
   - LED2 is turned ON when the reception process is completed.
   - LED1 is turned ON when the transmission process is completed.
